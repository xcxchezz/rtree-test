...
/**
 * Демонстрационная программа для работы с R-деревом
 * Uses simplified implementation for Java 8 compatibility
 */
public class MainDemo {

    public static void main(String[] args) {
        System.out.println("=== Демонстрация работы R-дерева ===\n");

        // Создаем упрощенное R-дерево с максимум 3 элементов в узле
        SimpleRTree<String> rtree = new SimpleRTree<>(3);
     ...
     */
    private static void insertData(SimpleRTree<String> rtree, double x1, double y1, double x2, double y2, String data) {
        SimpleRectangle rect = new SimpleRectangle(x1, y1, x2, y2);
     ...
     */
    private static void searchAndPrint(SimpleRTree<String> rtree, double x1, double y1, double x2, double y2) {
        SimpleRectangle searchRect = new SimpleRectangle(x1, y1, x2, y2);
